...
// $image=$_FILES['f1']['tmp_name']; very good code
 ...
 $target = "images/".basename($image);
  ...
  $ins=mysqli_query($con,"insert into add_new_machine(m_img,m_name,m_number,rokhsa_date,tameen_date,fahs_date,m_work_loc,rec_date,masol_name,hours,m_status,m_type,main_date,main_pay)values('$image','$_POST[name]',$_POST[num],'$_POST[rokh]','$_POST[tameen]','$_POST[fahs]','$_POST[loc]','$_POST[rec_date]','$_POST[masol]',$_POST[hours1],'$_POST[ch1]','$_POST[type]','$_POST[main_date]',$_POST[main_pay])");
 ...
 {
  ?>
  <script>confirm("تم اضافة سيارة الى النظام بنجاح");
window.location.replace("add_frame_edara_from_select.php");
</script>
 ...
 //add to add_new_machine_edara table
 $ins=mysqli_query($con,"insert into add_new_machine_edara(m_img,m_name,m_number,rokhsa_date,tameen_date,fahs_date,m_work_loc,rec_date,masol_name,hours,m_status,m_type,main_date,main_pay)values('$image','$_POST[name]',$_POST[num],'$_POST[rokh]','$_POST[tameen]','$_POST[fahs]','$_POST[loc]','$_POST[rec_date]','$_POST[masol]',$_POST[hours1],'$_POST[ch1]','$_POST[type]','$_POST[main_date]',$_POST[main_pay])");
}
// }
...
<h2 class="text-center">أضافة سيارة إلى النظام</h2>
