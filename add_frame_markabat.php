...
// $image=$_FILES['f1']['tmp_name']; very good code
 ...
 {
  ?>
  <script>confirm("تم اضافة مركبة الى النظام بنجاح");
window.location.replace("add_frame_markabat.php");
</script>
 ...
 //add into add_new_machine_markbat
...
<h2 class="text-center">أضافة مركبات إلى النظام</h2>
