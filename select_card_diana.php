...
// $sel=mysqli_query($con,"select * from add_new_machine_diana");
...
<a href="add_frame_diana_from_select.php"><button style="font-size:18px" class="btn btn-primary mb-5 mt-3">اضافة ديانا جديدة <i class="fa fa-plus"></i></button></a>
...
$sel=mysqli_query($con,"select * from add_new_machine_diana where m_name like '%$_POST[search]%'");
...
<div class="col">
 ...
 <button id="<?php echo $res['id']?>" type="button" class=" bbb btn btn-primary" data-bs-toggle="modal" data-bs-target="#myModal">
          ...
          <!-- update button -->
            <form action="update_moda_diana.php" method="post">
           ...
           {
            $del=mysqli_query($con,"delete from add_new_machine_diana where id='$_POST[id1]'");
           $nam=$_POST['nname'];
            ...
            if($del)
            {
              ...
              <script>
                ...
                if(x==0)
                {
                  window.location.replace('select_card_diana.php');
           ...
           <form action="maint_new_diana.php" method="post">
...
$(document).ready(function(){
  ...
  id_emp = $(this).attr('id')
  // alert(id_emp);
        $.ajax({url: "select_in_modal_diana.php",
        method:'post',
        data:{id:id_emp},
