...
// $sel=mysqli_query($con,"select * from add_new_machine_mdakhat");
...
<!--  -->
    ...
    <a href="add_frame_mdkhat_from_select.php"><button style="font-size:18px" class="btn btn-primary mb-5 mt-3">اضافة مضخة - كرين جديدة <i class="fa fa-plus"></i></button></a>
...
$sel=mysqli_query($con,"select * from add_new_machine_mdakhat where m_name like '%$_POST[search]%'");
...
<div class="col">
 ...
 <button id="<?php echo $res['id']?>" type="button" class=" bbb btn btn-primary" data-bs-toggle="modal" data-bs-target="#myModal">
          ...
          <!-- update button -->
            <form action="update_moda_mdkhat.php" method="post">
           ...
           {
            $del=mysqli_query($con,"delete from add_new_machine_mdakhat where id='$_POST[id1]'");
           $nam=$_POST['nname'];
  ...
  <!-- add to maint_new_1 جدول الاعطال الجديد -->
           <form action="maint_new_mdakhat.php" method="post">
...
$(document).ready(function(){
  ...
  id_emp = $(this).attr('id')
  // alert(id_emp);
        $.ajax({url: "select_in_modal_mdakhat.php",
        method:'post',
        data:{id:id_emp},
...
$sel_where_date=mysqli_query($con,"select * from add_new_machine_mdakhat where  rokhsa_date='$d'");
...
غدا
      ...
      <?php
      include('connect.php');
      $sel_alarm=mysqli_query($con,"select * from add_new_machine_mdakhat");
...
$sel_where_date1=mysqli_query($con,"select * from add_new_machine_mdakhat where  	tameen_date='$d1'");
...
<div class=" mine_alarm alert alert-danger alert-dismissible fade show w-25 fixed-top" style="top:120px;right:75% ;background-color:red;color:yellow;" id="alarmm1">
      ...
      <?php
      include('connect.php');
      $sel_alarm1=mysqli_query($con,"select * from add_new_machine_mdakhat");
...
$sel_where_date2=mysqli_query($con,"select * from add_new_machine_mdakhat where  fahs_date='$d2'");
...
<div class=" mine_alarm alert alert-danger alert-dismissible fade show w-25 fixed-top" style="top:180px;right:75% ;background-color:red;color:yellow;" id="alarmm_fahs">
      ...
      <?php
      include('connect.php');
      $sel_alarm2=mysqli_query($con,"select * from add_new_machine_mdakhat");
...
$sel_where_date3=mysqli_query($con,"select * from add_new_machine_mdakhat where  main_date='$d3'");
        ...
        while($res_where_date3=mysqli_fetch_array($sel_where_date3))
{
      ...
      <?php
      include('connect.php');
      $sel_alarm3=mysqli_query($con,"select * from add_new_machine_mdakhat");
