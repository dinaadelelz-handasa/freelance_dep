...
$id=$_POST['id_up'];
$sel=mysqli_query($con,"select * from add_new_machine where id='$id'");
...
<input type="text" name="id" value='<?php echo $row["id"]?>' readonly class="">
...
$up_img=mysqli_query($con,"update add_new_machine set m_img='$image' where id='$id'");
