...
//update معطلة
$update2=mysqli_query($con,"update add_new_machine_mdakhat set m_status='$_POST[motla]' where m_name='$_POST[ss]'");
// if($update)
// {
...
<!-- name coming from selec_card_qalabat rather than select only in this  -->
        ...
        $sel_from_machin_qlabat=mysqli_query($con,"select * from add_new_machine_mdakhat where id='$id_from_qlabat'");
    ...
    <table class="table">
        ...
        <tr>
           ...
           if(isset($_POST['delete']))
           {
            ...
            $upd_add_qalab=mysqli_query($con,"update add_new_machine_mdakhat set m_status='قيد التشغيل' where m_name='$name11'");
            if($del)
            {
              ?>
              <script>
