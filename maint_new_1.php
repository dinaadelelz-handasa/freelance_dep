...
//update_qlbat_machine table معطلة
$update2=mysqli_query($con,"update add_new_machine_qlabat set m_status='$_POST[motla]' where m_name='$_POST[ss]'");
// if($update)
// {
...
<!-- name coming from selec_card_qalabat rather than select only in this  -->
        ...
        $sel_from_machin_qlabat=mysqli_query($con,"select * from add_new_machine_qlabat where id='$id_from_qlabat'");
