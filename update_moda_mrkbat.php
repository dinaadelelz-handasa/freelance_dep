...
$id=$_POST['id_up'];
$sel=mysqli_query($con,"select * from add_new_machine_mrkabat where id='$id'");
...
$up_img=mysqli_query($con,"update add_new_machine_mrkabat set m_img='$image' where id='$id'");
