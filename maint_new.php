...
$update2=mysqli_query($con,"update add_new_machine_bus set m_status='$_POST[motla]' where m_name='$_POST[ss]'");

$update3=mysqli_query($con,"update add_new_machine_diana set m_status='$_POST[motla]' where m_name='$_POST[ss]'");

$update4=mysqli_query($con,"update add_new_machine_edara set m_status='$_POST[motla]' where m_name='$_POST[ss]'");

$update5=mysqli_query($con,"update add_new_machine_ksarat set m_status='$_POST[motla]' where m_name='$_POST[ss]'");

$update6=mysqli_query($con,"update add_new_machine_mdakhat set m_status='$_POST[motla]' where m_name='$_POST[ss]'");

$update7=mysqli_query($con,"update add_new_machine_mrkabat set m_status='$_POST[motla]' where m_name='$_POST[ss]'");

$update8=mysqli_query($con,"update add_new_machine_qlabat set m_status='$_POST[motla]' where m_name='$_POST[ss]'");
...
<h3 class="text-center text-primary">اضافة الى الاعطال</h3>
    ...
    <!-- <div class="row mb-2">
        <div class="col-sm-3"><label for="">ID</label></div>
        <div class="col-sm-6">
          
          <input type="text" name="mutual_id"  value="" class="form-control" disabled>
        </div>
        </div> -->
    ...
    <table class="table">
        ...
        <input type="hidden" name="name_pay" value="<?php echo $res_otl['name']?>">
           ...
           if(isset($_POST['delete']))
           {
            ...
            // $update_select_card=mysqli_query($con,"update add_new_machine set m_status='قيد التشفغيل' where m_name=''");  خليها الوقتي
