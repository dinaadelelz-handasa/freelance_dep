...
<!--  -->
    ...
    <a href="add_frame_okhra_from_select.php"><button style="font-size:18px" class="btn btn-primary mb-5 mt-3">اضافة معدة جديدة <i class="fa fa-plus"></i></button></a>
...
$sel=mysqli_query($con,"select * from add_new_machine where m_name like '%$_POST[search]%'");
           ...
           $nam=$_POST['nname'];
            ...
            if($del)
            {
              ...
              <script>
                ...
                if(x==0)
                {
                  window.location.replace('select_card_okhra.php');
...
<!-- add to maint_new_1 جدول الاعطال الجديد -->
            <form action="maint_new_okhra.php" method="post">
