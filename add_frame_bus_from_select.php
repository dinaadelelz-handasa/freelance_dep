...
// $image=$_FILES['f1']['tmp_name']; very good code
 ...
 {
  ?>
  <script>confirm("تم اضافة باص الى النظام بنجاح");
window.location.replace("add_frame_bus_from_select.php");
</script>
 ...
 // add to add_new_machine_bus table
 $ins=mysqli_query($con,"insert into add_new_machine_bus(m_img,m_name,m_number,rokhsa_date,tameen_date,fahs_date,m_work_loc,rec_date,masol_name,hours,m_status,m_type,main_date,main_pay,addad,shraa,waseqa)values('$image','$_POST[name]',$_POST[num],'$_POST[rokh]','$_POST[tameen]','$_POST[fahs]','$_POST[loc]','$_POST[rec_date]','$_POST[masol]',$_POST[hours1],'$_POST[ch1]','$_POST[type]','$_POST[main_date]',$_POST[main_pay],'$_POST[addad]','$_POST[shraa]','$_POST[waseqa]')");
}
// }
